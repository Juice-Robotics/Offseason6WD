...
public class PurePursuitFollower {
    ...
    public double pt_to_pt_distance (double[] pt1, double [] pt2) {
        return java.lang.Math.sqrt(Math.pow((pt2[0] - pt1[0]), 2)+ Math.pow((pt2[1] - pt1[1]), 2));
    }


    public Pose2d update(Path pathp) {
